...
#define STRING_CONFIG_H_AUTHOR "Venelin Efremov" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_PRNTR_V2
  #define PRNTR_V2_REV 3
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.95,  13.95 }
    #define DEFAULT_Ki_LIST {   0.96,   0.96 }
    #define DEFAULT_Kd_LIST {  50.61,  50.61 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 79.47
  #define DEFAULT_bedKi 14.82
  #define DEFAULT_bedKd 284.18
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 416 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 40, 150 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 60, 250 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 20000, 20000, 2000, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 25.0, -2 }
...
//#define NEOPIXEL_LED
  ...
  // NEOPIXEL_PIN is defined in pins_PRNTR_V2.h

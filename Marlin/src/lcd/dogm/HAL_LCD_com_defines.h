...
#include <U8glib.h>
  ...
  uint8_t u8g_com_HAL_stm32f4_st7920_sw_spi_fn(u8g_t *u8g, uint8_t msg, uint8_t arg_val, void *arg_ptr);
  ...
  #define U8G_COM_ST7920_HAL_SW_SPI u8g_com_HAL_stm32f4_st7920_sw_spi_fn

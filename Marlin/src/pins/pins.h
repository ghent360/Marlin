...
#elif MB(PRNTR_V2)
  #include "stm32f4/pins_PRNTR_V2.h"            // STM32F4                                env:STM32F4
#elif MB(PRNTR_F407_V1)
  #include "stm32f4/pins_PRNTR_F407_V1.h"       // STM32F4                                env:STM32F4
#elif MB(PRNTR_F407_2209)
  #include "stm32f4/pins_PRNTR_F407_2209.h"     // STM32F4                                env:STM32F4

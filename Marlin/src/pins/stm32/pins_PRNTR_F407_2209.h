...
#define BOARD_NAME "Marlin for PrntrBoard 2209(F407)"
...
#define FAN2_PIN           SLOW_PIN(D, 9)   // E0 Cool / TC1
...
#define GREEN_LED_PIN      SLOW_PIN(B, 9)   // Green LED control

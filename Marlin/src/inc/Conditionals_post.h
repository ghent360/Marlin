...
// Determine which type of 'EEPROM' is in use
  ...
  #if NONE(FLASH_EEPROM_EMULATION, SRAM_EEPROM_EMULATION, SDCARD_EEPROM_EMULATION) && ANY(I2C_EEPROM, SPI_EEPROM, SPI_FLASH, QSPI_EEPROM)
...
#define HAS_E_STEPPER_ENABLE (HAS_E_DRIVER(TMC2660) \
  || ( E0_ENABLE_PIN != X_ENABLE_PIN && E0_ENABLE_PIN != Y_ENABLE_PIN   \
    && E1_ENABLE_PIN != X_ENABLE_PIN && E1_ENABLE_PIN != Y_ENABLE_PIN   \
    && E2_ENABLE_PIN != X_ENABLE_PIN && E2_ENABLE_PIN != Y_ENABLE_PIN) \
)

...
#define INIT_FAN_PIN(P) do{ _INIT_FAN_PIN(P); SET_FAST_PWM_FREQ(P); }while(0)
  ...
  #if HAS_FAN3
    #define INIT_E_AUTO_FAN_PIN(P) do{ if (P == FAN1_PIN || P == FAN2_PIN || P == FAN3_PIN) { SET_PWM(P); SET_FAST_PWM_FREQ(P); } else pinMode(P, OUTPUT); }while(0)
  #else
    #define INIT_E_AUTO_FAN_PIN(P) do{ if (P == FAN1_PIN || P == FAN2_PIN) { SET_PWM(P); SET_FAST_PWM_FREQ(P); } else pinMode(P, OUTPUT); }while(0)
  #endif
#else
  ...
  #if HAS_FAN3
    #define INIT_CHAMBER_AUTO_FAN_PIN(P) do{ if (P == FAN1_PIN || P == FAN2_PIN || P == FAN3_PIN) { SET_PWM(P); SET_FAST_PWM_FREQ(P); } else pinMode(P, OUTPUT); }while(0)
  #else
    #define INIT_CHAMBER_AUTO_FAN_PIN(P) do{ if (P == FAN1_PIN || P == FAN2_PIN) { SET_PWM(P); SET_FAST_PWM_FREQ(P); } else pinMode(P, OUTPUT); }while(0)
  #endif
#else
